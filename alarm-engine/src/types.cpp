...
const char* condition_to_string(Condition c) noexcept {
    switch (c) {
        case Condition::GreaterThan: return "gt";
        case Condition::LessThan: return "lt";
        case Condition::GreaterOrEqual: return "gte";
        case Condition::LessOrEqual: return "lte";
...
Condition condition_from_string(const std::string& s) {
    if (s == "lt") return Condition::LessThan;
    if (s == "gte") return Condition::GreaterOrEqual;
    if (s == "lte") return Condition::LessOrEqual;
    if (s == "eq") return Condition::Equal;
